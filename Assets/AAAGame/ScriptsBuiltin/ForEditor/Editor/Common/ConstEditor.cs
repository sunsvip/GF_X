...
namespace UGF.EditorTools
{
    ...
    public class ConstEditor
    {
        ...
        public const string DataTableCodeTemplate = "Assets/AAAGame/ScriptsBuiltin/ForEditor/Editor/DataTableGenerator/DataTableCodeTemplate/DataTableCodeTemplate.txt"; //生成配置表代码的模板文件
